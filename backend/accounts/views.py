...
def create_admin_user(request):
    """Temporary endpoint to create admin user - remove after setup"""
    import os
    
    # Security check - only allow if specific environment variable is set
    if not os.getenv('ALLOW_ADMIN_CREATION', '').lower() == 'true':
        return Response({
